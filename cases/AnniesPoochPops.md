...
Pennsylvania law permits a prothonotary {% marginnote "margin-note-id" "'Prothonotary' is the title of the chief clerk in most Pennsylvania state courts. This is one of many quaint features of the Pennsylvania legal system, lending a Dickensian air to litigation in the Keystone State." %} of any of its courts of common pleas {% marginnote "margin-note-id" "The Courts of Common Pleas are the principal trial-level courts, analogous to the Superior Court in North Carolina." %} to enter judgment by confession, in ministerial fashion, when a plaintiff files a complaint that, among other requisites, includes a copy of an instrument that the defendant has signed authorizing such judgment.
